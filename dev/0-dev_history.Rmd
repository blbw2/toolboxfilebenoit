...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Boite à outils d'analyse de données",
    Description = "Un package regroupant des fonctions pratiques pour analyser des données.",
    `Authors@R` = c(
      person("Benoit", "Williatte", email = "benoit.williatte@sciencespo.fr", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Benoit Williatte")
```
